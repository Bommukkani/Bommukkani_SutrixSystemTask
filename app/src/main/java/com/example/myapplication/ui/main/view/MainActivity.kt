...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mShared_Common_Pref: Shared_Common_Pref
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.v(TAG,"onCreatedgghed")
        bottomNavigation = findViewById(R.id.bottom_navigation)
        mServiceFragment = ServiceFragment()
        mCartFragment = CartFragment()
        mShared_Common_Pref=Shared_Common_Pref(applicationContext)
        ...
        bottomNavigation?.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                ...
                R.id.page_2 -> {
                    if (mShared_Common_Pref.getvalue("cart_group_data").equals(""))
